...
exports.updateDoctorValidation = [
  ...
  body('newPatientConsultationRequests')
    .optional()
    .isBoolean()
    .withMessage('newPatientConsultationRequests must be a boolean'),
  body('patientMessages')
    .optional()
    .isBoolean()
    .withMessage('patientMessages must be a boolean'),
  body('prescriptionUpdates')
    .optional()
    .isBoolean()
    .withMessage('prescriptionUpdates must be a boolean'),
  body('paymentNotifications')
    .optional()
    .isBoolean()
    .withMessage('paymentNotifications must be a boolean'),
  body('platformPolicyUpdates')
    .optional()
    .isBoolean()
    .withMessage('platformPolicyUpdates must be a boolean'),
  body('weeklyPerformanceReports')
    .optional()
    .isBoolean()
    .withMessage('weeklyPerformanceReports must be a boolean'),
];
