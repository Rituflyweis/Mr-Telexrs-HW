...
router.get('/getOrdersForDoctor',auth, controller.getOrdersForDoctor);
...
// Create order as a Doctor - Send to Pharmacy 
router.post('/ordersByDoctor', auth, controller.createOrderByDoctor);

router.post('/ordersByDoctorWithPrescription', auth, controller.createPrescriptionOrderByDoctor);
