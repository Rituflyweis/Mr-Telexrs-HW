...
router.post('/intake-form-fields', intakeFormFieldValidation.addIntakeFormFieldValidation, intakeFormFieldValidation.validateFieldTypeOptions, validate, intakeFormFieldController.addIntakeFormField);
// Getzall intake form fields
...
router.put('/intake-form-fields/:id', intakeFormFieldValidation.updateIntakeFormFieldValidation, intakeFormFieldValidation.validateFieldTypeOptions, validate, intakeFormFieldController.updateIntakeFormField);
// Delete intake form field
router.delete('/intake-form-fields/:id', intakeFormFieldController.deleteIntakeFormField);
// Reorder fields
router.post('/intake-form-fields/reorder', intakeFormFieldController.reorderFields);




router.post('/createSection', intakeFormFieldController.createSection);
// Getzall intake form fields
router.get('/getSections', intakeFormFieldController.getSections);
// Get intake form field by ID
router.get('/getSectionById/:id', intakeFormFieldController.getSectionById);
// Update intake form field
router.put('/updateSection/:id', intakeFormFieldController.updateSection);
// Delete intake form field
router.delete('/deleteSection/:id', intakeFormFieldController.deleteSection);
