...
router.post('/register', adminValidation.adminRegisterValidation, adminController.adminRegister);
// Admin login (public route)
router.post('/login', adminValidation.adminLoginValidation, adminController.adminLogin);
